...
%calculate vc(:,1) vp(:,1) vc(:,2) vp(:,2)
clc
clear


gc(:,1) = [-0.3520 - 0.1639i;0.2730 + 0.6405i];
gp(:,1) = [0.1697 + 0.2841i;0.1733 + 0.1567i];
gc(:,2) = [-0.1478 - 0.0519i;-0.0879 - 0.4007i];
gp(:,2) = [0.2490 + 0.3453i;-0.0598 - 0.1202i];
