...
function [C] = Test_1025(realization,sigma,StepSize,k,z)


for Traning_length = 1:z
    
    Traning_length
    
    C(Traning_length)=0;

    for zz = 1:realization
        ...
        C(Traning_length)=C(Traning_length)+( log2(1+SINR_C(1))+log2(1+SINR_P(1))+log2(1+SINR_C(2))+log2(1+SINR_P(2)) )/realization;
